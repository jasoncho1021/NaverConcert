...
public class ProductController {
	...
	public ResponseEntity<DisplayInfoDTO> productDetail(@PathVariable Integer displayInfoId) {
		return new ResponseEntity<>(productService.getDisplayInfoById(displayInfoId), HttpStatus.OK);
	}
}
