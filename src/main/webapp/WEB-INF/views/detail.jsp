...
<body>
	<div id="container">
		<div class="header fade">
			...
			<!-- 
				...
				<a href="#" class="btn_my"> <span title="${reservationEmail}">${reservationEmail}</span>
				</a>
				 -->
			</header>
		</div>
			...
			<div>
				<div class="section_visual">
					<header>
						...
						<c:choose>
							<c:when test="${not empty reservationEmail}">
								<a href="myreservation" class="btn_my"> <span
									class="viewReservation" title="${reservationEmail}">${reservationEmail}</span>
								</a>
							</c:when>
						...
						<input type="hidden" id="reservationEmail" name="reservationEmail"
								...
								<ul class="detail_info_group">
									...
									<li class="detail_info_lst"><strong class="in_tit">[공지사항]</strong>
										<ul class="in_img_group">
											<li class="in_img_lst"><img alt="공지사항이미지"
												class="img_thumb"
	...
	<script type="rv-template" id="reservationCommentHandleBar">
		<li class="list_item">
			<div>
