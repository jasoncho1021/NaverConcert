				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<input type="checkbox" name="rating2" value="1" class="rating_rdo" title="1점" checked="true">
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									...
									<img src="http://naverbooking.phinf.naver.net/20170306_3/1488772023601A4195_JPEG/image.jpg?type=f300_300" width="130" alt="업로드 이미지 썸네일" class="item_thumb">
