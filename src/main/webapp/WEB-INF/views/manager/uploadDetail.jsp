...
<body>
        ...
        <div class="ct main">
            <div>
                        ...
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul class="visual_img detail_swipe">
                                    <!-- 
                                    <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="/img/detail_demo2.jpg"></span>
                                        <div class="visual_txt">
                                            <div class="visual_txt_inn">
                                                <h2 class="visual_txt_tit"> <span>타이틀</span> </h2>
                ...
                <div class="section_review_list">
                            ...
                            <ul class="list_short_review">
                                <li class="list_item">
                                    <div>
                                        <div class="review_area">
                                            ...
                                            <p class="review">2층이어서 걱정했는데 꽤잘보여서 좋았습니다 고미오 너무 멋있었습니다 사진은 커튼콜때 찍었습니다 끝나고
                                                퇴근길도 봐서 너무 좋았어요</p>
                                        </div>
                                        <div class="info_area">
                                            <div class="review_info"> <span class="grade">4.0</span> <span
                                                    class="name">dbfl****</span> <span class="date">2017.3.5. 방문</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div>
                                        ...
                                        <div class="info_area">
                                            <div class="review_info"> <span class="grade">5.0</span> <span
                                                    class="name">yyck****</span> <span class="date">2017.3.5. 방문</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="list_item">
                                    <div>
                                        <div class="review_area no_img">
                                            <h4 class="resoc_name"></h4>
                                            <p class="review">좋은 공연이었습니다. <br>머큐쇼역활 하신분의 열창이 기억에 남는 반면에,,, 로미오는 별로 기억에
                                                남지 않네요..</p>
                                        </div>
                                        <div class="info_area">
                                            <div class="review_info"> <span class="grade">4.0</span> <span
                                                    class="name">xero****</span> <span class="date">2017.3.4. 방문</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <a class="btn_review_more" href="./review.html"> <span>예매자 한줄평 더보기</span> <i
                                ...
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span
                                                    ...
                                                    href="tel:02-548-0597" class="store_tel">02-548-0597</a></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script type="rv-template" id="productImageHandleBar">
        <li class="item" style="width: 414px;" idx={{idx}}> 
    ...
    <script src="/js/manager/detailpageAPI.js" defer></script>
    <script src="/js/manager/carousel.js"></script>
