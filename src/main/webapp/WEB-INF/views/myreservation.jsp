		...
		<div class="ct">
			<div class="section_my">
				...
				<!-- 			<div class="link_booking_details">
								...
								<!-- <article class="card_item">
									<input type=hidden id="reservationInfoId" name="reservationInfoId" value="1">
									<a href="#" class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
											<div class="middle">
 ...
 -->							</li>
		...
		<input type=hidden id="reservationEmail" name="reservationEmail" value="${reservationEmail}">
			<script type="rv-template" id="reservationItem">
					...
					<script type="rv-template" id="confirmedDiv">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
					...
					<script type="rv-template" id="shareButton">
						<a href="#" class="fn fn-share1 naver-splugin btn_goto_share" title="공유하기"></a>
					</script>
